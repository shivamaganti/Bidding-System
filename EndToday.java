  ...
  extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    try
    {
      ...
      pw.println("<center><h2>Closing ITems Today </h2></center><br>");
      ...
      Date sdate;
      for (; rs2.next(); pw.println("<td align=center>" + sdate + "</td></tr>"))
      {
      ...
      pw.println("<center><h2>Closing ITems Tomorrow </h2></center><br>");
      ...
      pw.println("</table></center><br><br><hr>");
      pw.println("<CENTER>");
