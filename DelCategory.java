  ...
  extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    String category = req.getParameter("chk");
    pw = res.getWriter();
    ...
    try
    {
      PreparedStatement pst = con.prepareStatement("delete from category_master where cat_name = ?");
      pst.setString(1, category);
      boolean b = pst.execute();
      System.out.println("b val :" + b);
      pw.println("<center>");
      if (!b) {
        pw.println("<h3> Successfully Deleted From Data Base </h3>");
      } else {
        pw.println("<h3>Data Base Error</h3>");
      }
      pst.close();
      con.close();
    }
